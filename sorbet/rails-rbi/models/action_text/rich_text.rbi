...
module ActionText::RichText::GeneratedSerializedAttributeMethods
  sig { returns(T.nilable(ActionText::Content)) }
  def body; end

  sig { params(value: T.nilable(ActionText::Content)).void }
  def body=(value); end
...
class ActionText::RichText < ActionText::Record
  include ActionText::RichText::GeneratedSerializedAttributeMethods
