...
Mailjet.configure do |config|
  config.api_key = Rails.application.credentials.mailjet[:api]
  config.secret_key = Rails.application.credentials.mailjet[:secret]
  config.default_from = Rails.application.credentials.mailjet[:from]
